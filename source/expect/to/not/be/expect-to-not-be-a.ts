...
export interface ExpectToNotBeAChain<TSubject> {

    /**
     * @example expect(actual).to.not.be.a(expected)
     *
     * @param expected
     */
    ...
    /**
     * @example expect(actual).to.not.be.a.string()
     */
    string(): AssertionResult<TSubject, TSubject, string>;

    /**
     * @example expect(actual).to.not.be.a.number()
     */
    number(): AssertionResult<TSubject, TSubject, number>;

    /**
     * @example expect(actual).to.not.be.a.bigint()
     */
    bigint(): AssertionResult<TSubject, TSubject, bigint>;

    /**
     * @example expect(actual).to.not.be.a.boolean()
     */
    boolean(): AssertionResult<TSubject, TSubject, boolean>;

    /**
     * @example expect(actual).to.not.be.a.symbol()
     */
    symbol(): AssertionResult<TSubject, TSubject, symbol>;

    /**
     * @example expect(actual).to.not.be.a.function()
     */
    // eslint-disable-next-line @typescript-eslint/ban-types
    function(): AssertionResult<TSubject, TSubject, Function>;
}

export function createExpectToNotBeAChain<TSubject>(subject: TSubject): ExpectToNotBeAChain<TSubject> {

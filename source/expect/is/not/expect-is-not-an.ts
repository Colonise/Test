...
export interface ExpectIsNotAnChain<TSubject> {

    /**
     * @example expect(actual).is.not.an(expected)
     *
     * @param expected
     */
    ...
    /**
     * @example expect(actual).is.not.an.object()
     */
    // eslint-disable-next-line @typescript-eslint/ban-types
    object(): AssertionResult<TSubject, TSubject, object>;
}

export function createExpectIsNotAnChain<TSubject>(subject: TSubject): ExpectIsNotAnChain<TSubject> {
